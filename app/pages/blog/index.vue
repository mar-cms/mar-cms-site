  ...
  <div class="v2-blog">
    ...
    <nav class="nav">
      <div class="nav-inner">
        ...
        <div class="nav-links">
          <NuxtLink :to="$localePath('/')">{{ $t('menu_home') }}</NuxtLink>
          <NuxtLink :to="$localePath('/') + '#problem'">{{ $t('v2_nav_problem') }}</NuxtLink>
          <NuxtLink :to="$localePath('/') + '#capabilities'">{{ $t('v2_nav_capabilities') }}</NuxtLink>
          <NuxtLink :to="$localePath('/') + '#hospitality'">{{ $t('v2_nav_hospitality') }}</NuxtLink>
          <NuxtLink :to="$localePath('/') + '#partnership'">{{ $t('v2_nav_partnership') }}</NuxtLink>
          <NuxtLink :to="$localePath('/') + '#faq'">FAQ</NuxtLink>
          <NuxtLink :to="$localePath('/blog')" class="active">{{ $t('blog') }}</NuxtLink>
        </div>
    ...
    <Transition name="mobile-menu">
      <div v-if="mobileMenu" class="mobile-overlay" @click="mobileMenu = false">
        <div class="mobile-drawer" @click.stop>
          <NuxtLink to="/" @click="mobileMenu = false">{{ $t('menu_home') }}</NuxtLink>
          <NuxtLink :to="$localePath('/') + '#problem'" @click="mobileMenu = false">{{ $t('v2_nav_problem') }}</NuxtLink>
          <NuxtLink :to="$localePath('/') + '#capabilities'" @click="mobileMenu = false">{{ $t('v2_nav_capabilities') }}</NuxtLink>
          <NuxtLink :to="$localePath('/') + '#hospitality'" @click="mobileMenu = false">{{ $t('v2_nav_hospitality') }}</NuxtLink>
          <NuxtLink :to="$localePath('/') + '#partnership'" @click="mobileMenu = false">{{ $t('v2_nav_partnership') }}</NuxtLink>
          <NuxtLink :to="$localePath('/') + '#faq'" @click="mobileMenu = false">FAQ</NuxtLink>
        ...
        <div class="featured-grid">
          ...
          >
            <div class="article-img-wrap">
              <NuxtImg :src="article.img" :alt="typeof article.title === 'object' ? article.title[locale] : article.title" class="article-img" width="800" height="450" />
            </div>
        ...
        <div v-if="otherArticles.length" class="other-grid">
          ...
          >
            <div class="article-img-wrap small">
              <NuxtImg :src="article.img" :alt="typeof article.title === 'object' ? article.title[locale] : article.title" class="article-img" width="600" height="338" loading="lazy" />
            </div>
            <div class="article-info">
