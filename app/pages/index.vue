<template>
  ...
  <section id="video" class="section dark-section">
    ...
    <div
      style="width: 70vw; height: 60vh; border-radius: 40px; overflow: hidden"
    >
      <iframe
        width="100%"
        height="100%"
        src="https://www.youtube.com/embed/xNUx-rMGvvw?si=NhyvRCF5e6-S4VbC&amp;controls=0"
